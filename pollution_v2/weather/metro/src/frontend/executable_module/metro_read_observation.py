...
"""
    ...
    Description:  check if a observation file is provided. Return an error message if not.
    ...
    def start(self):
        ...
        if sFilename != "":
            try:
                ...
                infdata_observation = metro_infdata.Metro_infdata('OBSERVATION',
            ...
            sError_message = _("METRo need an observation file, please use ") + _("the option: '--input-observation'")
            metro_logger.print_message(metro_logger.LOGGER_MSG_STOP, sError_message)
