    ...
    def start(self):
        ...
        if sFilename != "":
            try:
                ...
                sError_message = _("No file was read. METRo may need this ") + _("file content later.")
            ...
            sError_message = _("If you want to read a second observation file,") + _("\nplease use the option: ") + \
                             _("'--input-observation-ref'.") + _("\nYou can safely remove this module from the ") + \
                             _("EXECUTION SEQUENCE\nif you don't need it.")
            metro_logger.print_message(metro_logger.LOGGER_MSG_WARNING, sError_message)
