...
# General
DEFAULT_TIMEZONE = pytz.timezone(os.getenv("DEFAULT_TIMEZONE", "UTC"))  # TODO: restore "Europe/Rome"?
...
DAG_POLLUTION_DISPERSAL_EXECUTION_CRONTAB = Variable.get("DAG_POLLUTION_DISPERSAL_EXECUTION_CRONTAB", "0 2 * * *")  # TODO: check if correct
...
POLLUTION_DISPERSAL_PREDICTION_ENDPOINT = Variable.get("POLLUTION_DISPERSAL_PREDICTION_ENDPOINT", "http://localhost:8086/predict")
