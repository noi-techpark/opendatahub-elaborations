...
# TODO restore 30
ODH_COMPUTATION_BATCH_SIZE = int(Variable.get("ODH_COMPUTATION_BATCH_SIZE", 3))
ODH_MINIMUM_STARTING_DATE = DEFAULT_TIMEZONE.localize(dateutil.parser.parse(Variable.get("ODH_MINIMUM_STARTING_DATE", "2018-01-01")))
