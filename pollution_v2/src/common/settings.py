...
ODH_COMPUTATION_BATCH_SIZE_VALIDATION = int(Variable.get("ODH_COMPUTATION_BATCH_SIZE_VALIDATION", 24))
...
POLLUTION_DISPERSAL_STARTING_DATE = dateutil.parser.parse(Variable.get("POLLUTION_DISPERSAL_STARTING_DATE", "2020-01-01 01:00"))
