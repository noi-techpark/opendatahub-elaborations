...
POLLUTION_DISPERSAL_PREDICTION_ENDPOINT = Variable.get("POLLUTION_DISPERSAL_PREDICTION_ENDPOINT", "http://pollution-dispersal:80/predict/?station_code=")
POLLUTION_DISPERSAL_STATION_MAPPING_ENDPOINT = Variable.get("POLLUTION_DISPERSAL_STATION_MAPPING_ENDPOINT", "http://pollution-dispersal:80/station_mapping")
