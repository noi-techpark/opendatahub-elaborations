...
from pollution_connector.settings import DEFAULT_TIMEZONE, SENTRY_SAMPLE_RATE
...
if __name__ == "__main__":
    ...
    arg_parser = argparse.ArgumentParser(description="Manually run a pollution computation")
