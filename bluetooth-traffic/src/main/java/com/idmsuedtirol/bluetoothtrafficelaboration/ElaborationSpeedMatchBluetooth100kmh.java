 ...
 */
public class ElaborationSpeedMatchBluetooth100kmh {

	private static Logger LOG = LoggerFactory.getLogger(ElaborationSpeedMatchBluetooth100kmh.class);
	...
	static String doElaboration(DatabaseHelper databaseHelper, final String args) throws SQLException, IOException {
		LOG.debug("Do speed-match 100kmh elaboration with args: " + args);
		...
		String result = databaseHelper.newConnection(new ConnectionReady<String>() {
			...
			public String connected(Connection conn) throws SQLException, IOException {
				String sql = DatabaseHelper.readResource(this.getClass(), "elaboration_speed_100kmh.sql");
